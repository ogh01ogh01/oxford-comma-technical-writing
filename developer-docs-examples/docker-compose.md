...
2. Add the `X-Alfresco-Search-Secret` header with the secret value, as seen in the image. <br/><br/>![Modheader](https://docs.hyland.com/p/alfresco){:width="460" height="380px"}
...
![Docker Compose - Enterprise](https://docs.hyland.com/p/alfresco){:width="460" height="380px"}
